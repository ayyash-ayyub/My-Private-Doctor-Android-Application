...
public class Penyakit1 extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		penyakit1 = getResources().getStringArray(R.array.gejala56);
		solusi = getResources().getStringArray(R.array.solusi56);
		tanyadokter = getResources().getStringArray(R.array.tanyadokter);
		
		
		
		pen.setMessage("Apakah anda terus waswas atau khawatir tanpa jelas sebabnya?")
		.setCancelable(false)
